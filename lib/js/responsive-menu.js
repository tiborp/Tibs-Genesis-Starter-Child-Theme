jQuery(document).ready(function ($) {
    ...
    $("#primary-menu-toggle .show").click(function () {
        if ($(".menu-mobile").is(":hidden")) {
            ...
            $("#primary-menu-toggle span").replaceWith("<span>Menu sluiten</span>")
        } else {
            $(".menu-mobile").hide(500);
            $(this).attr("class", "toggle-switch show").attr("title", "Menu");
            $("#primary-menu-toggle span").replaceWith("<span>Menu</span>")
        }
    });
